...
import navLogo from "/volunteerNexus.png";
...
export const NavItems = ({ items, className, onItemClick, isActiveRoute }) => {
                ...
                return (
                    ...
                    >
                        ...
                        {isActive && (
                            <Motion.div
                                layoutId="active"
                                className="absolute inset-0 h-full w-full rounded-full bg-blue-100 dark:bg-blue-900/30"
                            />
                        )}
